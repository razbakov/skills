...
metadata:
  install: "npm install -g @anthropic/acli confluence-cli"
  env:
    CONFLUENCE_DOMAIN: "Atlassian site domain, e.g. yoursite.atlassian.net"
    ...
    CONFLUENCE_API_PATH: "Confluence REST API path (default: /wiki/rest/api)"
    CONFLUENCE_AUTH_TYPE: "Auth type for Confluence (default: basic)"
    JIRA_SITE: "Jira site domain, e.g. yoursite.atlassian.net"
    JIRA_EMAIL: "Email address for Jira authentication"
    JIRA_API_TOKEN: "Atlassian API token for Jira access"
---
