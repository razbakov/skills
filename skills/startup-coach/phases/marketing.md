...
- Create `campaign.md` using → `templates/campaign.md`
- Create `content-plan.md` using → `templates/content-plan.md`
- Create each `posters/<name>.md` using → `templates/poster.md`
